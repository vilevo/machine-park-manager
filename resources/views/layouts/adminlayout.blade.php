                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href=''>
                                ...
                                <span class="nav-text">RDV non confirmés</span>
                            </a>
                        </li>
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href=''>
                                ...
                                <span class="nav-text">RDV confirmés</span>
                            </a>
                        </li>
                    ...
                    <div class="navbar-right ">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="github-link mr-3">
                                <a class="btn btn-outline-secondary btn-sm" href="https://coursierdhopital.org/" target="_blank">
                                    <span class="d-none d-md-inline-block mr-2">Site Web</span>
                                </a>
                            ...
                            <li class="dropdown notifications-menu">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li class="dropdown-header">Vous avez demandes de RDV</li>
                                    <li>

                                        <a href="">
                                            <i class="mdi mdi-calendar-blank"></i> - RDV à
